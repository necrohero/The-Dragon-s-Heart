...
function s.flipcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetCurrentChain()==0 and once==0 and Duel.GetFieldGroupCount(tp,LOCATION_DECK,0)>0 and s[2+tp]>=8000 -- same as up this one and Duel.GetDrawCount(tp)>0 and Duel.IsExistingMatchingCard(Card.IsAbleToHand,tp,LOCATION_DECK,0,1,nil)
end
